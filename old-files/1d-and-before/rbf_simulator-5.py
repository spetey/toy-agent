...
DEFAULT_TAPE_SIZE = 32  # Address space size (all addresses wrap mod this)
...
def interactive_session():
    ...
    sim = RBFSimulator(tape_size=DEFAULT_TAPE_SIZE)
...
Commands:
  ...
  load <file>           Load saved state from file (adds .rbf)
                                ...
                                if '=' in line:
                                    ...
                                    if key == 'tape_size':
                                        ...
                                        if new_size != sim.tape_size:
                                            sim = RBFSimulator(tape_size=new_size)
                                    elif key == 'ip':
                                        sim.ip = int(val)
                                    elif key == 'cl':
                                        sim.cl = int(val)
